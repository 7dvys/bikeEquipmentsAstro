...
const Navbar = () => {
  return (
    <nav id='navbar' className="navbar navbar-expand-lg blur border-radius-sm top-0 z-index-3 shadow position-sticky py-3 start-0 end-0">
      <div className="container">
        <img src={logoBlack.src} className='d-inline' style={{width:60}}  alt="bike equipments logo" />
        <a className="navbar-brand font-weight-bolder fs-5 ms-lg-2 " href="/">Bike Equipments</a>
        ...
        <div className="collapse navbar-collapse" id="navigation">
          <ul className="navbar-nav ms-auto">
            ...
            <li className="nav-item">
              <a className="nav-link text-dark font-weight-bold d-flex align-items-center me-2 " aria-current="page" href="/landing#nosotros">
                Nosotros
              </a>
            </li>
            {/* <li className="nav-item">
            ...
            <li className="nav-item">
              <a className="nav-link text-dark font-weight-bold d-flex align-items-center me-2 " aria-current="page" href="https://discord.com/invite/TGZqBvZB" rel="nofollow" target="_blank">
                <i className="fab text-lg fa-discord"></i>
                        ...
                        <li className="nav-item">
              <a className="nav-link text-dark font-weight-bold d-flex align-items-center me-2 " aria-current="page" href="/contacto">
                Contacto
              </a>
            </li>
          </ul>
